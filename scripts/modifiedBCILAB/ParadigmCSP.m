classdef ParadigmCSP < ParadigmDataflowSimplified
    ...
    %                            2010-04-29
    %
    % Annotation by NB: In order to replace BCILABs automatic (i.e.
    % artifact-blind) CSP calculation procedure by our semi-automatic CSP calculation procedure, a few code lines have been replaced within this script
    % The respective changes are marked by "NB modification".
    ...
    methods
        ...
        function model = feature_adapt(self,varargin)
            ...
            % NB Modification: Remove default CSP caclulation from BCILAB
            %{
            for k=1:2
            ...
            % NB Modification: Instead, import semi-automatically retrived
            % CSP filters
            global subinf;
            model.filters = subinf.filters; 
            model.patterns = subinf.patterns; 
            model.chanlocs = signal.chanlocs;
